...
export function InventoryItemDrawer(props: {
  ...
  return (
    <>
      ...
      <div style={{ position: "fixed", top: 0, right: 0, bottom: 0, zIndex: 901, width: "min(520px, 92vw)", background: "#0e1220", borderLeft: "1px solid rgba(255,255,255,0.12)", display: "flex", flexDirection: "column", boxShadow: "-8px 0 30px rgba(0,0,0,0.5)" }}>
        <div style={{ padding: "18px 20px 14px", borderBottom: "1px solid rgba(255,255,255,0.08)", display: "flex", alignItems: "center", justifyContent: "space-between", gap: 8 }}>
          ...
          <button type="button" onClick={props.onClose} style={plainBtn}>Close</button>
        </div>
