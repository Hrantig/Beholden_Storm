      ...
      for (const combat of combats) {
        ...
        for (const [ci, raw] of combatants.entries()) {
          const c: StoredCombatant = {
            ...
            focusCurrent: raw["focusCurrent"] != null ? Number(raw["focusCurrent"]) : null,
            focusMax: raw["focusMax"] != null ? Number(raw["focusMax"]) : null,
            investitureCurrent: raw["investitureCurrent"] != null ? Number(raw["investitureCurrent"]) : null,
            investitureMax: raw["investitureMax"] != null ? Number(raw["investitureMax"]) : null,
